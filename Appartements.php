...
<div class="container">
  ...
  <div class="property-card">
    <img src="apart1.jpg" alt="Maison moderne">
    <div class="property-info">
      <h2>Appartement Meublé</h2>
      <p><span class="tag vente">Vente</span> Usage habitation</p>
  ...
  <!-- Propriété 2 -->
  <div class="property-card">
    <img src="apart2 (2).jpg" alt="Appartement à louer">
    <div class="property-info">
      <h2>Appartement Meublé</h2>
      <p><span class="tag location">Location</span> Usage habitation</p>
  ...
  <!-- Propriété 3 -->
  <div class="property-card">
    <img src="apart3.jpg" alt="Terrain à vendre">
    <div class="property-info">
      <h2>Appartement Meublé</h2>
      <p><span class="tag vente">Vente</span> Usage habitation</p>
...
<div class="container">
  ...
  <!-- Propriété 1 -->
  <div class="property-card">
    <img src="apart4.jpg" alt="Maison moderne">
    <div class="property-info">
      <h2>Appartement Meublé</h2>
      <p><span class="tag vente">Vente</span> Usage habitation</p>
      <p><strong>Localisation :</strong> Ouagadougou, Zone du bois</p>
  ...
  <!-- Propriété 2 -->
  <div class="property-card">
    <img src="apart5.jpg" alt="Appartement à louer">
    <div class="property-info">
      <h2>Appartement Meublé</h2>
      <p><span class="tag location">Location</span> Usage habitation</p>
      <p><strong>Localisation :</strong> Bobo-Dioulasso, Quartier 117</p>
  ...
  <!-- Propriété 3 -->
  <div class="property-card">
    <img src="apart6.jpg" alt="Terrain à vendre">
    <div class="property-info">
      <h2>Appartement Meublé</h2>
      <p><span class="tag vente">Vente</span> Usage habitation</p>
      <p><strong>Localisation :</strong> Ouaga 2000, Secteur 15</p>
